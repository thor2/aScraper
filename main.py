"""This script serves as an example on how to use Python 
   ...
   This script is used to scrape hiking trails from Google Maps
   It will scrape the top 100 hiking trails for a given search query
   and save the data to an excel and csv file.
   The script will save the data to the output folder.
